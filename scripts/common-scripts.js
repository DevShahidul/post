            ...
            var $line = $('.nav-marker'),
                ...
                animLine = function ($target) {
                    var offsetConteneur = $nav.offset().left,
                     ...
                     TweenMax.to($line, 1.2, {css:{left: posX1}, ease:Power4.easeOut});
                };
    ...
    /*$('.mosuecontroller').each(function(){
      ...
      function positionCircle(e, media, circle) {
        ...
        $('.category-item').each(function () {
         ...
         $('.work-single-video').mouseenter(function () {
                $('body').addClass('start-event');
                $('body').mousemove(function (e) {
                    var cursor = $('#cursorplay'),
                        ancho = cursor.width(),
                        alto = cursor.height(),
                        W = ancho / 2,
                        H = alto / 2,
            ...
            $('.work-single-video').on('mouseleave', function () {
                $('body').removeClass('start-event');
            });
        
            $('.work-single-video').on('click', function(e){
                var playPause = $('.js-playTrigger');
